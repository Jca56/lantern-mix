...
| D15 | 2026-08-29 | **Big text is a hard requirement**: body ≥ 22 px, readouts 40–48 px, hit targets ≥ 48 px, nothing under 20 px. Palette undecided until there's a screen to look at. | Vision accessibility. |
